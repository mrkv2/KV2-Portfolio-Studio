...
Depuis la V1.2.1, chaque galerie possède une ancre stable. Les liens des filtres et le formulaire de recherche conservent cette ancre lors du rechargement côté serveur : l’utilisateur revient directement au portfolio au lieu d’être renvoyé en haut de la page. Une marge de défilement protège les contrôles sous les en-têtes fixes.
