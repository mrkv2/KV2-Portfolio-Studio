...
define( 'KV2PS_VERSION', '1.3.0-emt.1' );
...
require_once KV2PS_DIR . 'includes/class-kv2ps-json.php';
require_once KV2PS_DIR . 'includes/class-kv2ps-image-metadata.php';
require_once KV2PS_DIR . 'includes/class-kv2ps-importer.php';
require_once KV2PS_DIR . 'includes/class-kv2ps-compatibility.php';
require_once KV2PS_DIR . 'includes/class-kv2ps-seo.php';
...
require_once KV2PS_DIR . 'includes/class-kv2ps-ets-mon-toit.php';
