...
* Ramène l’utilisateur directement aux filtres après leur rechargement côté serveur.
* Protège les contrôles sous les en-têtes fixes grâce à une marge de défilement.
