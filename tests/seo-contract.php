...
$_GET = array();
$GLOBALS['kv2ps_test_meta']['_kv2ps_publication_mode'] = 'gallery';
$robots = KV2PS_SEO::filter_robots( array( 'index' => 'index', 'follow' => 'follow' ) );
if ( 'noindex' !== $robots['index'] || 'follow' !== $robots['follow'] ) {
	throw new RuntimeException( 'Gallery-only records were not marked noindex, follow.' );
}
$GLOBALS['kv2ps_test_meta']['_kv2ps_publication_mode'] = '';
