...
$required_contracts = array(
	...
	array( 'plugin', 'kv2ps_private_city', 'Confidential city terms must be excluded from public search.' ),
	array( 'plugin', 'kv2ps_private_meta', 'Confidential location metadata must be excluded from public search.' ),
	array( 'plugin', "array_diff( \$search_taxonomies, array( 'kv2_ville' ) )", 'Confidential city labels must not be exposed in card or lightbox data.' ),
);
